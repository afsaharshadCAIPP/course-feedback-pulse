...
def translate_to_english(text, lang_code):
    """Best-effort translation via Google Translate, then the original text.
    ...
    It has been removed for stability — Google Translate needs no local model and
    works fine as long as the deployment has normal outbound internet access."""
